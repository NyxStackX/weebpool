...
Ce dépôt contient mon site portfolio personnel.

## Note Git

Le repository est configuré pour suivre les fichiers du projet (site portfolio), avec des exclusions ciblées dans `.gitignore`.

Exemple de règle active :
